...
```
┌─────────────────────────────────────────────────────────────────────────────────────────────────────┐
│  DISCLAMER: ALL the code is vibes and written by Claude Code.                                       │
│             This project is a test to see how well AI is currently adapted and ready for production.│ 
│             The different GIT commits represent different phases of the project.                    │ 
│             The different MD files represent the different project/cost documents.                  │ 
└─────────────────────────────────────────────────────────────────────────────────────────────────────┘
```

A modern, full-stack pizza ordering application built with Rust, Leptos, and SurrealDB. This project demonstrates a complete web application with a reactive frontend, RESTful API backend, and cloud-native deployment, vibed with Claude Code's AI assistance. No lines of code has been manually written.

Stack: SALT: SurrealDB - Axum - Leptos - ThailwindCSS

[![Rust](https://img.shields.io/badge/Rust-1.93%2B-orange)](https://www.rust-lang.org/)
[![Leptos](https://img.shields.io/badge/Leptos-0.8-blue)](https://leptos.dev/)
